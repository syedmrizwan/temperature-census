...
var (
	...
	MPressue = stats.Float64("pressure", "Pressure", "mb")

	MHumidity = stats.Float64("humidity", "Humidity", "%")
...
func getTemperatureDetail() (*model.TemperatureDetail, error) {
	client := resty.New()
	...
	var tempDetail model.TemperatureDetail
...
func doEvery(d time.Duration, f func() (*model.TemperatureDetail, error)) {
